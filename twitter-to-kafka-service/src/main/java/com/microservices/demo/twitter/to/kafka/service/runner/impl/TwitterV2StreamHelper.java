...
public class TwitterV2StreamHelper {
    ...
    public TwitterV2StreamHelper(TwitterToKafkaServiceConfigData config, TwitterKafkaStatusListener listener){
    ...
    private void createRules(String bearerToken, Map<String, String> rules) throws URISyntaxException, IOException {
        ...
        URIBuilder uriBuilder = new URIBuilder(twitterToKafkaServiceConfigData.getTwitterRulesV2BaseUrl());
